...
@section('title', 'Tambah Produk - Admin HP Market')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden fade-in-up">
            ...
            <div class="gradient-primary px-6 py-5 flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-lg font-extrabold text-white">Tambah Produk</h1>
                    <p class="text-white/70 text-xs">Isi detail produk baru untuk ditambahkan ke katalog.</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              ...
                              placeholder="Deskripsikan produk HP ini...">{{ old('description') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="specifications" rows="3"
                              class="input-field w-full px-4 py-3 rounded-xl bg-gray-50 text-sm resize-none"
                              placeholder="Contoh: RAM 8GB | Storage 256GB | Layar 6.7 inch | Baterai 5000mAh">{{ old('specifications') }}</textarea>
